...
<body data-spy="scroll" data-target=".navbar" data-offset="50" style="width:100%;height:100%;">
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.php">BuyIt!</a><!--id daal-->
    </div>
    <div>
				...
				<p>From fashion week coverage and the best dressed stars on the red carpet, to what's chic on the streets and trends to watch out for this season</p>		
					<div class="about-w3ls-row">
						...
						<ul id="flexiselDemo3">
							...
							<li> 
								<img src="images/wp1.jpg" class="img-responsive" alt="" />
							</li>
							<li> 
								<img src="images/j1.jpg" class="img-responsive" alt="" />
							</li>
							<li> 
								<img src="images/suit2.jpg" class="img-responsive" alt="" />
							</li>
						</ul> 
			...
			<div class="col-md-4 about-grids">
					...
					<div class="pince">
						...
						<div class="pince-right">
							<p>Your Favorite brands delivered to you at your doorstep</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="pince">
					...
					<div class="pince">
						...
						<div class="pince-right">
							<p>Get the product within 5 working days!</p>
						</div>
						<div class="clearfix"> </div>
					</div>
			</div>
